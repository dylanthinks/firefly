...
var quote = [];
// I want to have a function that applies to any button clicked,
// where the button will automatically select a random string
// from the array matching the character on the button that was just clicked
 ...
 function zoeGen(min, max){
       var zoeQuote = zoe[Math.floor(Math.random() * zoe.length)]


};

 function jayneGen(min, max){
       var jayneQuote = jayne[Math.floor(Math.random() * jayne.length)]


};

 function washGen(min, max){
       var washQuote = wash[Math.floor(Math.random() * wash.length)]


};

 function kayleeGen(min, max){
       var kayleeQuote = kaylee[Math.floor(Math.random() * kaylee.length)]


};

 function inaraGen(min, max){
       var inaraQuote = inara[Math.floor(Math.random() * inara.length)]


};

 function bookGen(min, max){
       var bookQuote = book[Math.floor(Math.random() * book.length)]


};

 function simonGen(min, max){
       var simonQuote = simon[Math.floor(Math.random() * simon.length)]


};

 function riverGen(min, max){
       var riverQuote = river[Math.floor(Math.random() * river.length)]
